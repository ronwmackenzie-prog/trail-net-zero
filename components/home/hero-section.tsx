...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: 'var(--section-light-blue)' }}>
      {/* Background Pattern */}
        ...
        <div className="grid items-center gap-8 lg:gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 max-w-lg text-base sm:text-lg leading-relaxed text-foreground/75">
              Join the professional community where trail race directors, brands, and sustainability 
              practitioners collaborate on evidence-based approaches to environmental impact.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:gap-4 sm:flex-row">
              ...
              <Button size="lg" variant="outline" asChild className="border-primary/20 text-foreground hover:bg-primary/10 hover:text-foreground bg-transparent">
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 sm:gap-8">
              <div>
                ...
                <p className="mt-1 text-xs sm:text-sm text-foreground/60">Practitioners</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-foreground">40+</p>
                <p className="mt-1 text-xs sm:text-sm text-foreground/60">Active Channels</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-foreground">100%</p>
                <p className="mt-1 text-xs sm:text-sm text-foreground/60">Evidence-Based</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative grid grid-cols-2 gap-3 sm:gap-4 rounded-2xl bg-white p-4 sm:p-6 shadow-xl">
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-muted p-4 sm:p-6">
                ...
                <p className="text-center text-xs sm:text-sm font-medium text-foreground">Race Operations</p>
              </div>
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-muted p-4 sm:p-6">
                <Leaf className="h-8 sm:h-10 w-8 sm:w-10 text-primary" />
                <p className="text-center text-xs sm:text-sm font-medium text-foreground">Sustainability</p>
              </div>
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-muted p-4 sm:p-6">
                <Users className="h-8 sm:h-10 w-8 sm:w-10 text-primary" />
                <p className="text-center text-xs sm:text-sm font-medium text-foreground">Community</p>
              </div>
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-primary p-4 sm:p-6">
                <span className="text-xl sm:text-2xl font-bold text-primary-foreground">TNZ</span>
                <p className="text-center text-xs sm:text-sm font-medium text-primary-foreground">Trail Net Zero</p>
              </div>
            </div>
          </div>
        </div>
